...
async def invite(ctx):
    em = discord.Embed(title = "Baksetball Beta", color=discord.Color.red())
...
async def daily(ctx):
        ...
        em.add_field(name="Description:", value="Gives the user $10,030 as a daily reward", inline=False)
